...
public class LeaderBoardService {
    ...
    public List<LeaderBoardResponse> getLeaderBoardWeekly() {
        ...
        String query = "SELECT e.user_name, t.distance_travel, e.carbon_emission, e.lead_points FROM emission_data e inner join trip_data t where e.trip_id = t.trip_id and t.trip_date>='2024-12-01' and t.trip_date<='2024-12-07'";
